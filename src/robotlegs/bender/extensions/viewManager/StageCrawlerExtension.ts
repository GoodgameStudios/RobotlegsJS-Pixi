...
export class StageCrawlerExtension implements IExtension {
    ...
    private scanViewManagedContainers(): void {
        ...
        const viewManager: IViewManager = this._injector.get<IViewManager>(IViewManager);
    ...
    private scanContextView(): void {
        ...
        const contextView: IContextView = this._injector.get<IContextView>(IContextView);
        contextView.view && this.scanContainer(contextView.view);
    }

    private scanContainer(container: any): void {
        const binding: ContainerBinding = this._containerRegistry.getBinding(container);
